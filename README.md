...
- [**1. Importer et créer
  l’objet**](##%201.%20Importer%20et%20créer%20l'objet)
  - [1.1. Importer un objet
    multigraphe](###%201.1.%20Importer%20un%20objet%20multigraphe)
  - [1.2. Importer des données au format csv et
    igraph](###%201.2.%20Importer%20des%20données%20au%20format%20csv%20et%20igraph)
  - [1.3. Appréhender les objets
    créés](###%201.3.%20Appréhender%20les%20objets%20créés)
  - [1.4. Aligner le multigraphe (tous les sommets dans toutes les
    couches)](###%201.4.%20Aligner%20le%20multigraphe%20(tous%20les%20sommets%20dans%20toutes%20les%20couches))
- [**2. Quelques mesures et
  analyses**](##%202.%20Quelques%20mesures%20et%20analyses)
  - [2.1. Créer et étudier les couches
    individuellemment](###%202.1.%20Créer%20et%20étudier%20les%20couches%20individuellemment)
  - [2.2. Centralités, voisinage,
    distances](###%202.2.%20Centralités,%20voisinage,%20distances)
  - [2.3. Comparaison des
    couches](###%202.3.%20Comparaison%20des%20couches)
  - [Suggesting changes](#suggesting-changes)
  - [2.4. Détection de
    communautés](###%202.4.%20Détection%20de%20communautés)
- [**3. Visualisation**](##%203.%20Visualisation)
- [**4. Références**](##%204.%20Références)
...
net <- ml_aucs()
layers_ml(net)
#> [1] "facebook" "lunch"    "work"     "coauthor" "leisure"
net
...
#>   from  to facebook lunch work coauthor leisure
#> 1  U54 U41        2     1    0        0       0
#> 2  U54 U41        0     0    3        0       0
```
...
#> 1   U54 U41        2     1    0        0       0
#> 7   U54 U41        2     0    1        1       0
#> 22  U54 U41        2     0    0        3       0
#> 25  U54 U41        2     0    0        1       1
#> 26  U54 U41        2     0    0        0       2
```
...
#>           facebook     lunch      work  coauthor   leisure
#> facebook 0.0000000 0.4207678 0.7106788 2.0214010 1.0177980
#> lunch    0.4207678 0.0000000 0.8372414 2.8966530 1.3288250
#> work     0.7106788 0.8372414 0.0000000 0.5917494 0.2118452
#> coauthor 2.0214010 2.8966530 0.5917494 0.0000000 0.4521076
#> leisure  1.0177980 1.3288250 0.2118452 0.4521076 0.0000000
```
...
#>              lunch  facebook  coauthor      work   leisure
#> lunch    0.0000000 1.4143833 3.4654016 0.3830254 1.6748765
#> facebook 1.4143833 0.0000000 0.4799452 0.1817213 0.2754121
#> coauthor 3.4654016 0.4799452 0.0000000 1.3307614 0.7262190
#> work     0.3830254 0.1817213 1.3307614 0.0000000 0.2961610
#> leisure  1.6748765 0.2754121 0.7262190 0.2961610 0.0000000
```
...
#>            facebook      lunch       work   coauthor   leisure
#> facebook 1.00000000 0.17843866 0.18656716 0.05839416 0.1584699
#> lunch    0.17843866 1.00000000 0.33910035 0.06467662 0.2772727
#> work     0.18656716 0.33910035 1.00000000 0.09137056 0.2051282
#> coauthor 0.05839416 0.06467662 0.09137056 1.00000000 0.1010101
#> leisure  0.15846995 0.27727273 0.20512821 0.10101010 1.0000000
```
...
#>             facebook       lunch        work    coauthor    leisure
#> facebook 1.000000000 0.069053708 0.046448087 0.005813953 0.02369668
#> lunch    0.069053708 1.000000000 0.151741294 0.007968127 0.10861423
#> work     0.046448087 0.151741294 1.000000000 0.009259259 0.07407407
#> coauthor 0.005813953 0.007968127 0.009259259 1.000000000 0.00000000
#> leisure  0.023696682 0.108614232 0.074074074 0.000000000 1.00000000
```
...
layers_ml(net)
#> [1] "facebook" "lunch"    "work"     "coauthor" "leisure"  "wfl"
