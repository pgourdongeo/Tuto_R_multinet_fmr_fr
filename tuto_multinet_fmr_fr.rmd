...
- [**1. Importer et créer l'objet**](## 1. Importer et créer l'objet)
  - [1.1. Importer un objet multigraphe](### 1.1. Importer un objet multigraphe)
  - [1.2. Importer des données au format csv et igraph](### 1.2. Importer des données au format csv et igraph)
  - [1.3. Appréhender les objets créés](### 1.3. Appréhender les objets créés)
  - [1.4. Aligner le multigraphe (tous les sommets dans toutes les couches)](### 1.4. Aligner le multigraphe (tous les sommets dans toutes les couches))
- [**2. Quelques mesures et analyses**](## 2. Quelques mesures et analyses)
  - [2.1. Créer et étudier les couches individuellemment](### 2.1. Créer et étudier les couches individuellemment)
  - [2.2. Centralités, voisinage, distances](### 2.2. Centralités, voisinage, distances)
  - [2.3. Comparaison des couches](### 2.3. Comparaison des couches)
  - [Suggesting changes](#suggesting-changes)
  - [2.4. Détection de communautés](### 2.4. Détection de communautés)
